...
class Steerer:
    ...
    def use_set_heading_request_event_processor(self, processor: event.processor.SetSpeedRequestProcessor) -> None:
        processor.add_handler(self.handle_heading_set_speed)

    def handle_heading_set_speed(self, speed: unit.UnitValue):
